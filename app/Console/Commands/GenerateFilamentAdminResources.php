...
class GenerateFilamentAdminResources extends Command
{
    ...
    protected array $modules = [
        ...
        ['model' => \App\Models\User::class, 'resource' => 'SubscriptionResource', 'list' => 'ListSubscriptionUsers', 'create' => null, 'edit' => null, 'view' => 'ViewSubscriptionUser', 'label' => '会员订阅', 'group' => '订单与财务', 'icon' => 'heroicon-o-credit-card', 'sort' => 20, 'canCreate' => false, 'viewOnly' => true],
