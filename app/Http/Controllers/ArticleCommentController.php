...
{
    public function store(Request $request, Article $article): RedirectResponse|JsonResponse
    {
    ...
    public function reply(Request $request, Comment $comment): RedirectResponse|JsonResponse
    {
        ...
        if (! $article instanceof Article || ! $article->is_published) {
            abort(404);
        }
    ...
    public function destroy(Comment $comment): JsonResponse
    {
        ...
        return response()->json(['success' => '评论已删除']);
    }
