...
{
    public function toggleLike(Request $request, UserPost $userPost): RedirectResponse
    {
    ...
    public function toggleFavorite(Request $request, UserPost $userPost): RedirectResponse
    {
        abort_unless($userPost->status === 'approved', 404);
        $this->abortIfNotPublicFeed($userPost);
