...
Route::middleware(['auth:sanctum', 'admin'])->group(function () {
    ...
    Route::get('points-ledger', [PointLedgerController::class, 'index']);
    ...
    Route::get('view-histories', [ViewHistoryAdminController::class, 'index']);
    Route::get('svip-custom-subscriptions', [SvipCustomSubscriptionAdminController::class, 'index']);
});
